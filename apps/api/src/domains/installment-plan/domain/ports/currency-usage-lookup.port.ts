export const INSTALLMENT_PLAN_CURRENCY_USAGE = Symbol("INSTALLMENT_PLAN_CURRENCY_USAGE");

/**
 * Minimal read port over the `installment-plan` table for domains that need
