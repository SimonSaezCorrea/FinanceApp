...
export class ReorderWalletHandler extends BaseCommandHandler<ReorderWalletCommand, wallet.WalletItem[], null> {
  constructor(
    eventBus: EventBus,
  ...
  protected async handle(command: ReorderWalletCommand): Promise<HandleResult<wallet.WalletItem[]>> {
