export const DEBT_CURRENCY_USAGE = Symbol("DEBT_CURRENCY_USAGE");

/**
 * Minimal read port over the `debt` table for domains that need to know
 * whether a currency is still in use by the caller before letting them
