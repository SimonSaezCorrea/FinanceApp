...
async function seedFullUser(passwordHash: string) {
  ...
  await prisma.debt.createMany({
    data: [
      ...
      {
        userId: javier.id, direction: "OWED_TO_YOU", counterparty: "María González",
        principal: dec("120000.0000"), currency: "CLP",
        openedAt: new Date("2026-06-11T00:00:00Z"), dueAt: new Date("2026-08-11T00:00:00Z"),
        totalInstallments: 3, paidInstallments: 1, installmentAmount: dec("40000.0000"),
        notes: "Préstamo en 3 cuotas",
      },
      // OWED_TO_YOU — deuda simple (1 cuota → botón "Marcar pagada")
      {
        userId: javier.id, direction: "OWED_TO_YOU", counterparty: "Pedro Soto",
        principal: dec("45000.0000"), currency: "CLP",
        openedAt: new Date("2026-05-20T00:00:00Z"), dueAt: new Date("2026-07-15T00:00:00Z"),
        totalInstallments: 1, paidInstallments: 0, installmentAmount: null,
      },
      // OWED_TO_YOU — en USD (para mostrar KPI multi-moneda)
      {
        userId: javier.id, direction: "OWED_TO_YOU", counterparty: "Roberto (viaje NY)",
        principal: dec("320.0000"), currency: "USD",
      ...
      {
        userId: javier.id, direction: "YOU_OWE", counterparty: "Tía Carmen",
        principal: dec("200000.0000"), currency: "CLP",
        openedAt: new Date("2026-05-01T00:00:00Z"), dueAt: new Date("2026-08-31T00:00:00Z"),
        totalInstallments: 4, paidInstallments: 2, installmentAmount: dec("50000.0000"),
        notes: "Préstamo familiar",
      },
      // YOU_OWE — en cuotas largas (0/6 pagadas → barra en cero)
      {
        userId: javier.id, direction: "YOU_OWE", counterparty: "Carlos (TV)",
        principal: dec("150000.0000"), currency: "CLP",
        openedAt: new Date("2026-06-15T00:00:00Z"),
        totalInstallments: 6, paidInstallments: 0, installmentAmount: dec("25000.0000"),
      },
      // YOU_OWE — saldada (no debe aparecer en lista activa)
      {
        userId: javier.id, direction: "YOU_OWE", counterparty: "Diego (arriendo)",
        principal: dec("89500.0000"), currency: "CLP",
        openedAt: new Date("2026-04-01T00:00:00Z"), dueAt: new Date("2026-05-15T00:00:00Z"),
        totalInstallments: 1, paidInstallments: 1, installmentAmount: null,
