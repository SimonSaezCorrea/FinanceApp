...
import { ListInstitutionsQueryHandler } from "../../../../../../src/domains/financial-institution/application/queries/list-institutions.handler";
import { ListInstitutionsQuery } from "../../../../../../src/domains/financial-institution/application/queries/list-institutions.query";
import type { InstitutionRepositoryPort } from "../../../../../../src/domains/financial-institution/domain/ports/institution.repository.port";
