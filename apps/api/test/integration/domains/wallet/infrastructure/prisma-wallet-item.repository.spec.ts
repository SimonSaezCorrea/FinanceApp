...
import { PrismaWalletItemRepository } from "../../../../../src/domains/wallet/infrastructure/prisma-wallet-item.repository";
...
describe("PrismaWalletItemRepository (integration)", () => {
  ...
  const repo = new PrismaWalletItemRepository(prisma);
