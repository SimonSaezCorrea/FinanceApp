...
import { PayCreditStatementCommand } from "../../../../../src/domains/accounts/application/commands/pay-credit-statement.command";
import { PayCreditStatementHandler } from "../../../../../src/domains/accounts/application/commands/pay-credit-statement.handler";
import { PrismaBankAccountRepository } from "../../../../../src/domains/accounts/infrastructure/prisma-bank-account.repository";
import { PrismaCreditStatementRepository } from "../../../../../src/domains/accounts/infrastructure/prisma-credit-statement.repository";
...
describe("PayCreditStatementHandler cross-aggregate transaction (integration)", () => {
  ...
  const statementRepo = new PrismaCreditStatementRepository(prisma);
