...
import { PrismaInstallmentPlanRepository } from "../../../../../src/domains/installments/infrastructure/prisma-installment-plan.repository";
...
describe("PrismaInstallmentPlanRepository (integration)", () => {
  ...
  const repo = new PrismaInstallmentPlanRepository(prisma);
